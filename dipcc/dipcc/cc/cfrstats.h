...
public:
  ...
  // Prune the specified actions for the specified power, then shift all the
  // remaining actions down in order.
  void prune_action_idxs(const std::vector<int> &action_idxs);
  ...
  // passed in, minus any pruned actions.
...
public:
  ...
  // Prune the specified actions for the specified power, then shift all the
  // remaining actions down in order.
  void prune_action_idxs(const std::string &power,
