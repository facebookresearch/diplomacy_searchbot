...
for (auto &order : it_loc_orders.second) { LOG(INFO) << "  " << order.to_string(); } }
...
for (auto& it : next.get_orderable_locations()) {
  for (Loc loc : it.second) { next_orderable_locs.insert(loc); }
}
...
EXPECT_TRUE(state.get_unit(Loc::LON).power == next.get_unit(Loc::YOR).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::YOR).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::VEN).power == next.get_unit(Loc::TRI).power && state.get_unit(Loc::VEN).type == next.get_unit(Loc::TRI).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::GAS).power == next.get_unit(Loc::SPA_NC).power && state.get_unit(Loc::GAS).type == next.get_unit(Loc::SPA_NC).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::NAO).power == next.get_unit(Loc::MAO).power && state.get_unit(Loc::NAO).type == next.get_unit(Loc::MAO).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::WES).power == next.get_unit(Loc::SPA_SC).power && state.get_unit(Loc::WES).type == next.get_unit(Loc::SPA_SC).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::WES).power == next.get_unit(Loc::SPA_SC).power && state.get_unit(Loc::WES).type == next.get_unit(Loc::SPA_SC).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::ANK).power == next.get_unit(Loc::CON).power && state.get_unit(Loc::ANK).type == next.get_unit(Loc::CON).type);
// expect success: A CON - SMY
EXPECT_TRUE(state.get_unit(Loc::CON).power == next.get_unit(Loc::SMY).power && state.get_unit(Loc::CON).type == next.get_unit(Loc::SMY).type);
// expect success: A SMY - ANK
EXPECT_TRUE(state.get_unit(Loc::SMY).power == next.get_unit(Loc::ANK).power && state.get_unit(Loc::SMY).type == next.get_unit(Loc::ANK).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::TRI).power == next.get_unit(Loc::SER).power && state.get_unit(Loc::TRI).type == next.get_unit(Loc::SER).type);
// expect success: A SER - BUL
EXPECT_TRUE(state.get_unit(Loc::SER).power == next.get_unit(Loc::BUL).power && state.get_unit(Loc::SER).type == next.get_unit(Loc::BUL).type);
// expect success: A BUL - TRI
EXPECT_TRUE(state.get_unit(Loc::BUL).power == next.get_unit(Loc::TRI).power && state.get_unit(Loc::BUL).type == next.get_unit(Loc::TRI).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::NAP).power == next.get_unit(Loc::ION).power && state.get_unit(Loc::NAP).type == next.get_unit(Loc::ION).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::LON).power == next.get_unit(Loc::BEL).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::BEL).type);
// expect success: A BEL - LON
EXPECT_TRUE(state.get_unit(Loc::BEL).power == next.get_unit(Loc::LON).power && state.get_unit(Loc::BEL).type == next.get_unit(Loc::LON).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::TRI).power == next.get_unit(Loc::VEN).power && state.get_unit(Loc::TRI).type == next.get_unit(Loc::VEN).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::PRU).power == next.get_unit(Loc::BER).power && state.get_unit(Loc::PRU).type == next.get_unit(Loc::BER).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::BER).power == next.get_unit(Loc::SWE).power && state.get_unit(Loc::BER).type == next.get_unit(Loc::SWE).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::ALB).power == next.get_unit(Loc::GRE).power && state.get_unit(Loc::ALB).type == next.get_unit(Loc::GRE).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::BLA).power == next.get_unit(Loc::ANK).power && state.get_unit(Loc::BLA).type == next.get_unit(Loc::ANK).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::BLA).power == next.get_unit(Loc::ANK).power && state.get_unit(Loc::BLA).type == next.get_unit(Loc::ANK).type);
// expect failure: A ARM - ANK
EXPECT_FALSE(state.get_unit(Loc::ARM).power == next.get_unit(Loc::ANK).power && state.get_unit(Loc::ARM).type == next.get_unit(Loc::ANK).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::ENG).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::ENG).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::VEN).power == next.get_unit(Loc::TRI).power && state.get_unit(Loc::VEN).type == next.get_unit(Loc::TRI).type);
// expect failure: A MUN - TYR
EXPECT_FALSE(state.get_unit(Loc::MUN).power == next.get_unit(Loc::TYR).power && state.get_unit(Loc::MUN).type == next.get_unit(Loc::TYR).type);
// expect success: A SIL - MUN
EXPECT_TRUE(state.get_unit(Loc::SIL).power == next.get_unit(Loc::MUN).power && state.get_unit(Loc::SIL).type == next.get_unit(Loc::MUN).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::KIE).power == next.get_unit(Loc::MUN).power && state.get_unit(Loc::KIE).type == next.get_unit(Loc::MUN).type);
// expect failure: F KIE - MUN
EXPECT_FALSE(state.get_unit(Loc::KIE).power == next.get_unit(Loc::MUN).power && state.get_unit(Loc::KIE).type == next.get_unit(Loc::MUN).type);
// expect success: A MUN - KIE
EXPECT_TRUE(state.get_unit(Loc::MUN).power == next.get_unit(Loc::KIE).power && state.get_unit(Loc::MUN).type == next.get_unit(Loc::KIE).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::SPA_NC).power == next.get_unit(Loc::LYO).power && state.get_unit(Loc::SPA_NC).type == next.get_unit(Loc::LYO).type);
// expect failure: F SPA/NC - LYO
EXPECT_FALSE(state.get_unit(Loc::SPA_NC).power == next.get_unit(Loc::LYO).power && state.get_unit(Loc::SPA_NC).type == next.get_unit(Loc::LYO).type);
// expect success: F LYO - SPA/SC
EXPECT_TRUE(state.get_unit(Loc::LYO).power == next.get_unit(Loc::SPA_SC).power && state.get_unit(Loc::LYO).type == next.get_unit(Loc::SPA_SC).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::MAR).power == next.get_unit(Loc::LYO).power && state.get_unit(Loc::MAR).type == next.get_unit(Loc::LYO).type);
// expect failure: A MAR - LYO
EXPECT_FALSE(state.get_unit(Loc::MAR).power == next.get_unit(Loc::LYO).power && state.get_unit(Loc::MAR).type == next.get_unit(Loc::LYO).type);
// expect success: F WES - LYO
EXPECT_TRUE(state.get_unit(Loc::WES).power == next.get_unit(Loc::LYO).power && state.get_unit(Loc::WES).type == next.get_unit(Loc::LYO).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::SER).power == next.get_unit(Loc::BUD).power && state.get_unit(Loc::SER).type == next.get_unit(Loc::BUD).type);
// expect success: A BUL - SER
EXPECT_TRUE(state.get_unit(Loc::BUL).power == next.get_unit(Loc::SER).power && state.get_unit(Loc::BUL).type == next.get_unit(Loc::SER).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::BER).power == next.get_unit(Loc::PRU).power && state.get_unit(Loc::BER).type == next.get_unit(Loc::PRU).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::KIE).power == next.get_unit(Loc::BER).power && state.get_unit(Loc::KIE).type == next.get_unit(Loc::BER).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::RUH).power == next.get_unit(Loc::HOL).power && state.get_unit(Loc::RUH).type == next.get_unit(Loc::HOL).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::HOL).power == next.get_unit(Loc::HOL).power && state.get_unit(Loc::HOL).type == next.get_unit(Loc::HOL).type);
...
EXPECT_TRUE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::NTH).type);
if (next.get_phase().phase_type == 'R') {
...
EXPECT_TRUE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::NWG).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::NWG).type);
// expect success: F NWY - NTH
EXPECT_TRUE(state.get_unit(Loc::NWY).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::NWY).type == next.get_unit(Loc::NTH).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::SPA).power == next.get_unit(Loc::POR).power && state.get_unit(Loc::SPA).type == next.get_unit(Loc::POR).type);
// expect success: F POR - SPA/NC
EXPECT_TRUE(state.get_unit(Loc::POR).power == next.get_unit(Loc::SPA_NC).power && state.get_unit(Loc::POR).type == next.get_unit(Loc::SPA_NC).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::GRE).power == next.get_unit(Loc::SEV).power && state.get_unit(Loc::GRE).type == next.get_unit(Loc::SEV).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::LON).power == next.get_unit(Loc::BRE).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::BRE).type);
// expect failure: A PAR - BRE
EXPECT_FALSE(state.get_unit(Loc::PAR).power == next.get_unit(Loc::BRE).power && state.get_unit(Loc::PAR).type == next.get_unit(Loc::BRE).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::LON).power == next.get_unit(Loc::HOL).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::HOL).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::BEL).power == next.get_unit(Loc::BEL).power && state.get_unit(Loc::BEL).type == next.get_unit(Loc::BEL).type);
if (next.get_phase().phase_type == 'R') {
...
EXPECT_TRUE(state.get_unit(Loc::BEL).power == next.get_unit(Loc::HOL).power && state.get_unit(Loc::BEL).type == next.get_unit(Loc::HOL).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::NTH).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::ENG).power == next.get_unit(Loc::ENG).power && state.get_unit(Loc::ENG).type == next.get_unit(Loc::ENG).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::WAL).power == next.get_unit(Loc::ENG).power && state.get_unit(Loc::WAL).type == next.get_unit(Loc::ENG).type);
// expect success: A NAF - WAL
EXPECT_TRUE(state.get_unit(Loc::NAF).power == next.get_unit(Loc::WAL).power && state.get_unit(Loc::NAF).type == next.get_unit(Loc::WAL).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::LON).power == next.get_unit(Loc::LON).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::LON).type);
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_orderable_locs, testing::Not(testing::Contains(Loc::LON)));
}
// expect ENG not dislodged
EXPECT_TRUE(state.get_unit(Loc::ENG).power == next.get_unit(Loc::ENG).power && state.get_unit(Loc::ENG).type == next.get_unit(Loc::ENG).type);
if (next.get_phase().phase_type == 'R') {
...
EXPECT_FALSE(state.get_unit(Loc::LON).power == next.get_unit(Loc::BEL).power && state.get_unit(Loc::LON).type == next.get_unit(Loc::BEL).type);
// expect NTH not dislodged
EXPECT_TRUE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::NTH).type);
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_orderable_locs, testing::Not(testing::Contains(Loc::NTH)));
...
EXPECT_TRUE(state.get_unit(Loc::TYR).power == next.get_unit(Loc::TYR).power && state.get_unit(Loc::TYR).type == next.get_unit(Loc::TYR).type);
if (next.get_phase().phase_type == 'R') {
...
EXPECT_FALSE(state.get_unit(Loc::ION).power == next.get_unit(Loc::ION).power && state.get_unit(Loc::ION).type == next.get_unit(Loc::ION).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::NAO).power == next.get_unit(Loc::NAO).power && state.get_unit(Loc::NAO).type == next.get_unit(Loc::NAO).type);
}
...
EXPECT_TRUE(state.get_unit(Loc::PIC).power == next.get_unit(Loc::ENG).power && state.get_unit(Loc::PIC).type == next.get_unit(Loc::ENG).type);
// expect success: F EDI - NTH
EXPECT_TRUE(state.get_unit(Loc::EDI).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::EDI).type == next.get_unit(Loc::NTH).type);
// expect NTH dislodged
EXPECT_FALSE(state.get_unit(Loc::NTH).power == next.get_unit(Loc::NTH).power && state.get_unit(Loc::NTH).type == next.get_unit(Loc::NTH).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::NWY).power == next.get_unit(Loc::BEL).power && state.get_unit(Loc::NWY).type == next.get_unit(Loc::BEL).type);
// expect failure: A BRE - LON
EXPECT_FALSE(state.get_unit(Loc::BRE).power == next.get_unit(Loc::LON).power && state.get_unit(Loc::BRE).type == next.get_unit(Loc::LON).type);
}
...
EXPECT_FALSE(state.get_unit(Loc::ANK).power == next.get_unit(Loc::ANK).power && state.get_unit(Loc::ANK).type == next.get_unit(Loc::ANK).type);
// expect retreat order not possible: F ANK R BLA
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_possible_orders[Loc::ANK], testing::Not(testing::Contains(Order("F ANK R BLA"))));
}
}
...
EXPECT_FALSE(state.get_unit(Loc::VIE).power == next.get_unit(Loc::VIE).power && state.get_unit(Loc::VIE).type == next.get_unit(Loc::VIE).type);
// expect retreat order not possible: A VIE R BOH
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_possible_orders[Loc::VIE], testing::Not(testing::Contains(Order("A VIE R BOH"))));
}
}
...
EXPECT_THAT(next_possible_orders[Loc::KIE], testing::Contains(Order("F KIE R BER")));
}
...
EXPECT_EQ(next.get_phase().phase_type, 'R') << "Should be retreat phase";
EXPECT_THAT(next_possible_orders[Loc::MAR], testing::Contains(Order("A MAR R GAS")));
}

// 6.H.12. TEST CASE, RETREAT WHEN DISLODGED BY ADJACENT CONVOY WHILE TRYING TO DO THE SAME
TEST_F(DATCTest, Test6H12) {
GameState state;
state.set_unit(Power::ENGLAND, UnitType::ARMY, Loc::LVP);
state.set_unit(Power::ENGLAND, UnitType::FLEET, Loc::IRI);
state.set_unit(Power::ENGLAND, UnitType::FLEET, Loc::ENG);
...
EXPECT_EQ(next.get_phase().phase_type, 'R') << "Should be retreat phase";
EXPECT_THAT(next_possible_orders[Loc::LVP], testing::Contains(Order("A LVP R EDI")));
}
...
EXPECT_FALSE(state.get_unit(Loc::PIC).power == next.get_unit(Loc::PIC).power && state.get_unit(Loc::PIC).type == next.get_unit(Loc::PIC).type);
// expect retreat order not possible: A PIC R LON
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_possible_orders[Loc::PIC], testing::Not(testing::Contains(Order("A PIC R LON"))));
}
}
...
EXPECT_FALSE(state.get_unit(Loc::POR).power == next.get_unit(Loc::POR).power && state.get_unit(Loc::POR).type == next.get_unit(Loc::POR).type);
// expect POR dislodged
EXPECT_FALSE(state.get_unit(Loc::POR).power == next.get_unit(Loc::POR).power && state.get_unit(Loc::POR).type == next.get_unit(Loc::POR).type);
}
...
if (next.get_phase().phase_type == 'R') {
EXPECT_THAT(next_possible_orders[Loc::WES], testing::Not(testing::Contains(Order("F WES R SPA/SC"))));
}
}
