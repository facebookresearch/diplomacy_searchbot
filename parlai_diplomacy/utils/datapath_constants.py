...
# Joined order and message data, DIPCC format
...
CHUNK_EXAMPLE_COUNT_PATH = (
    "/checkpoint/fairdiplomacy/press_diplomacy/joined_jsons/example_counts.json"  # 2020-08-21
)
