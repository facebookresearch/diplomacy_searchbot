...
# Params
sweep_name = "resume_allorder_shortstate_bart_diplomacy"
NUM_HOURS = 72
...
grid = {
    ...
    "-m": ["bart",],
    "--init-model": [
        "/checkpoint/wyshi/20200826/allorder_shortstate_bart_diplomacy/18e/model.checkpoint",
    ],
    "--n-positions": [1024],
    "--dict_file": [
        "/checkpoint/wyshi/20200826/allorder_shortstate_bart_diplomacy/18e/model.dict"
    ],
    "--label-truncate": [512],
    "--log_every_n_secs": [10],
    "-lr": [4.91e-05],
