...
CHUNK_DATAPATH = '/checkpoint/fairdiplomacy/chat_messages_jsons/large_jsons_nostream/redacted_messages_*.json'
...
if __name__ == '__main__':
    ...
    tot = len(glob(CHUNK_DATAPATH))
    for i, fle in enumerate(glob(CHUNK_DATAPATH)):
