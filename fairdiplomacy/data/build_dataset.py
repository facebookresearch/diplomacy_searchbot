...
TERR_ID_TO_LOC_BY_MAP = {1: TERR_ID_TO_LOC, 15: TERR_ID_TO_LOC_FRANCE_VS_AUSTRIA}

COUNTRY_ID_TO_POWER_MY_MAP = {1: COUNTRY_ID_TO_POWER, 15: COUNTRY_ID_TO_POWER_FRANCE_VS_AUSTRIA}
    ...
    try:
        ...
        if hasattr(err, "partial_game"):
            ...
            with open(partial_save_path, "w") as f:
                f.write(err.partial_game.to_json())
