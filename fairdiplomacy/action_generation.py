...
from fairdiplomacy.models.diplomacy_model.diplomacy_model import NO_ORDER_ID, EOS_IDX
...
ADJ_MAPPING = {'ADR': ['ALB', 'APU', 'ION', 'TRI', 'VEN'], 'AEG': ['BUL', 'CON', 'EAS', 'GRE', 'ION', 'SMY'], 'ALB': ['ADR', 'GRE', 'ION', 'SER', 'TRI'], 'ANK': ['ARM', 'BLA', 'CON', 'SMY'], 'APU': ['ADR', 'ION', 'NAP', 'ROM', 'VEN'], 'ARM': ['ANK', 'BLA', 'SEV', 'SMY', 'SYR'], 'BAL': ['BER', 'BOT', 'DEN', 'KIE', 'LVN', 'PRU', 'SWE'], 'BAR': ['NWG', 'NWY', 'STP'], 'BEL': ['BUR', 'ENG', 'HOL', 'NTH', 'PIC', 'RUH'], 'BER': ['BAL', 'KIE', 'MUN', 'PRU', 'SIL'], 'BLA': ['ANK', 'ARM', 'BUL', 'CON', 'RUM', 'SEV'], 'BOH': ['GAL', 'MUN', 'SIL', 'TYR', 'VIE'], 'BOT': ['BAL', 'FIN', 'LVN', 'STP', 'SWE'], 'BRE': ['ENG', 'GAS', 'MAO', 'PAR', 'PIC'], 'BUD': ['GAL', 'RUM', 'SER', 'TRI', 'VIE'], 'BUL': ['AEG', 'BLA', 'CON', 'GRE', 'RUM', 'SER'], 'BUR': ['BEL', 'GAS', 'MAR', 'MUN', 'PAR', 'PIC', 'RUH'], 'CLY': ['EDI', 'LVP', 'NAO', 'NWG'], 'CON': ['AEG', 'ANK', 'BLA', 'BUL', 'SMY'], 'DEN': ['BAL', 'HEL', 'KIE', 'NTH', 'SKA', 'SWE'], 'EAS': ['AEG', 'ION', 'SMY', 'SYR'], 'EDI': ['CLY', 'LVP', 'NTH', 'NWG', 'YOR'], 'ENG': ['BEL', 'BRE', 'IRI', 'LON', 'MAO', 'NTH', 'PIC', 'WAL'], 'FIN': ['BOT', 'NWY', 'STP', 'SWE'], 'GAL': ['BOH', 'BUD', 'RUM', 'SIL', 'UKR', 'VIE', 'WAR'], 'GAS': ['BRE', 'BUR', 'MAO', 'MAR', 'PAR', 'SPA'], 'GRE': ['AEG', 'ALB', 'BUL', 'ION', 'SER'], 'HEL': ['DEN', 'HOL', 'KIE', 'NTH'], 'HOL': ['BEL', 'HEL', 'KIE', 'NTH', 'RUH'], 'ION': ['ADR', 'AEG', 'ALB', 'APU', 'EAS', 'GRE', 'NAP', 'TUN', 'TYS'], 'IRI': ['ENG', 'LVP', 'MAO', 'NAO', 'WAL'], 'KIE': ['BAL', 'BER', 'DEN', 'HEL', 'HOL', 'MUN', 'RUH'], 'LON': ['ENG', 'NTH', 'WAL', 'YOR'], 'LVN': ['BAL', 'BOT', 'MOS', 'PRU', 'STP', 'WAR'], 'LVP': ['CLY', 'EDI', 'IRI', 'NAO', 'WAL', 'YOR'], 'LYO': ['MAR', 'PIE', 'SPA', 'TUS', 'TYS', 'WES'], 'MAO': ['BRE', 'ENG', 'GAS', 'IRI', 'NAF', 'NAO', 'POR', 'SPA', 'WES'], 'MAR': ['BUR', 'GAS', 'LYO', 'PIE', 'SPA'], 'MOS': ['LVN', 'SEV', 'STP', 'UKR', 'WAR'], 'MUN': ['BER', 'BOH', 'BUR', 'KIE', 'RUH', 'SIL', 'TYR'], 'NAF': ['MAO', 'TUN', 'WES'], 'NAO': ['CLY', 'IRI', 'LVP', 'MAO', 'NWG'], 'NAP': ['APU', 'ION', 'ROM', 'TYS'], 'NWY': ['BAR', 'FIN', 'NTH', 'NWG', 'SKA', 'STP', 'SWE'], 'NTH': ['BEL', 'DEN', 'EDI', 'ENG', 'HEL', 'HOL', 'LON', 'NWG', 'NWY', 'SKA', 'YOR'], 'NWG': ['BAR', 'CLY', 'EDI', 'NAO', 'NTH', 'NWY'], 'PAR': ['BRE', 'BUR', 'GAS', 'PIC'], 'PIC': ['BEL', 'BRE', 'BUR', 'ENG', 'PAR'], 'PIE': ['LYO', 'MAR', 'TUS', 'TYR', 'VEN'], 'POR': ['MAO', 'SPA'], 'PRU': ['BAL', 'BER', 'LVN', 'SIL', 'WAR'], 'ROM': ['APU', 'NAP', 'TUS', 'TYS', 'VEN'], 'RUH': ['BEL', 'BUR', 'HOL', 'KIE', 'MUN'], 'RUM': ['BLA', 'BUD', 'BUL', 'GAL', 'SER', 'SEV', 'UKR'], 'SER': ['ALB', 'BUD', 'BUL', 'GRE', 'RUM', 'TRI'], 'SEV': ['ARM', 'BLA', 'MOS', 'RUM', 'UKR'], 'SIL': ['BER', 'BOH', 'GAL', 'MUN', 'PRU', 'WAR'], 'SKA': ['DEN', 'NTH', 'NWY', 'SWE'], 'SMY': ['AEG', 'ANK', 'ARM', 'CON', 'EAS', 'SYR'], 'SPA': ['GAS', 'LYO', 'MAO', 'MAR', 'POR', 'WES'], 'STP': ['BAR', 'BOT', 'FIN', 'LVN', 'MOS', 'NWY'], 'SWE': ['BAL', 'BOT', 'DEN', 'FIN', 'NWY', 'SKA'], 'SYR': ['ARM', 'EAS', 'SMY'], 'TRI': ['ADR', 'ALB', 'BUD', 'SER', 'TYR', 'VEN', 'VIE'], 'TUN': ['ION', 'NAF', 'TYS', 'WES'], 'TUS': ['LYO', 'PIE', 'ROM', 'TYS', 'VEN'], 'TYR': ['BOH', 'MUN', 'PIE', 'TRI', 'VEN', 'VIE'], 'TYS': ['ION', 'LYO', 'NAP', 'ROM', 'TUN', 'TUS', 'WES'], 'UKR': ['GAL', 'MOS', 'RUM', 'SEV', 'WAR'], 'VEN': ['ADR', 'APU', 'PIE', 'ROM', 'TRI', 'TUS', 'TYR'], 'VIE': ['BOH', 'BUD', 'GAL', 'TRI', 'TYR'], 'WAL': ['ENG', 'IRI', 'LON', 'LVP', 'YOR'], 'WAR': ['GAL', 'LVN', 'MOS', 'PRU', 'SIL', 'UKR'], 'WES': ['LYO', 'MAO', 'NAF', 'SPA', 'TUN', 'TYS'], 'YOR': ['EDI', 'LON', 'LVP', 'NTH', 'WAL']}


@torch.no_grad()
def generate_orders_from_model(
    model,
    game,
    ...
    *,
    ...
    observations = feature_encoder.encode_inputs([game])
    ...
    def fwd(batch_indices):
        ...
        order_indices, action_logprobs, _ = model_output_transform(
            x, model(**x, temperature=temperature, top_p=top_p, x_power=x_power)
        )
...
@torch.no_grad()
def generate_order_by_column_from_model(
    model, game, selected_power, num_threads=10, temperature=1.0, top_p=1.0, *, max_actions=None
) -> List[Action]:
    """Produce action set where each unit tries all possible orders."""
    power_index = POWERS.index(selected_power)
    feature_encoder = FeatureEncoder(num_threads)
    observations = feature_encoder.encode_inputs([game])
    ...
    for location in range(len(power_possible_actions)):
        ...
        for _ in range(num_rounds):
            order_indices, _, _ = batched_forward(
                lambda x: model_output_transform(
                    x, model(**x, temperature=temperature, top_p=top_p)
                ),
                loc_obserbations,
...
def make_supports_coordinated(orders: List[str]) -> bool:
...
def produce_local_loc_dicts(
    ...
    *,
    ...
    logging.info("Close locations: %s", close_locations)
...
def generate_coordinated_local_modifications(
    ...
    *,
    ...
    for orders in actions:
        logging.info("Building local modifications of %s", orders)
...
def get_all_possible_orders_fast(
    ...
    good_locs = sorted(game.get_orderable_locations()[power])
    all_per_loc = game.get_all_possible_orders()
    all_per_loc = {loc: all_per_loc[loc] for loc in good_locs}
...
def generate_double_oracle_actions(
    ...
    device = next(iter(agent.model.model.parameters())).device
    ...
    if generation_cfg.column is not None:
        if generation_cfg.column.model_path:
            diplomacy_model = load_model.load_diplomacy_model_model_cached(
                checkpoint_path=generation_cfg.column.model_path, map_location=device
            )
        else:
            diplomacy_model = agent.model.model
        for power in allowed_powers:
            all_actions[power].update(
                _show(
                    f"{power} per_pos",
                    generate_order_by_column_from_model(
                        model=diplomacy_model,
                        game=game,
                        selected_power=power,
                        max_actions=generation_cfg.max_actions,
    ...
    if generation_cfg.model is not None:
        if generation_cfg.model.model_path:
            diplomacy_model = load_model.load_diplomacy_model_model_cached(
                checkpoint_path=generation_cfg.model.model_path, map_location=device
            )
        else:
            diplomacy_model = agent.model.model
        for power in allowed_powers:
            all_actions[power].update(
                _show(
                    f"{power} model",
                    generate_orders_from_model(
                        model=diplomacy_model,
                        game=game,
                        selected_power=power,
                        max_actions=generation_cfg.max_actions,
                        temperature=generation_cfg.model.temperature,
                        location_order=generation_cfg.model.location_order,
                    ),
                )
            )
